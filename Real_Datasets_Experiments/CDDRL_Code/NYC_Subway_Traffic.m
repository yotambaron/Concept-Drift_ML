...
% Load Data
data_path = 'D:\yotam\MATLAB\Stress_Experiments\CD_Real_Datasets\Data\NYC_Subway_Traffic';
save_path = 'D:\yotam\MATLAB\Stress_Experiments\CD_Real_Datasets\Results\NYC_Subway_Traffic';
df = readtable([data_path '\NYC_Traffic_Discretization_18Vars_Entries.csv']); % Discritizied database
df = table2array(df);
...
dag = Causal_Explorer('MMHC',initial_df,max(initial_df),'MMHC',[],100,'unif');
dag = full(dag);
dag = abs(dag);
