...
save_path = 'D:\yotam\MATLAB\Stress_Experiments\CD_Real_Datasets\Results\Electricity';
...
UCL_Array.Properties.VariableNames = {'day' 'hour' 'nsw_price' 'nsw_demand' 'vic_price' 'vic_demand' 'transfer' 'class'};
