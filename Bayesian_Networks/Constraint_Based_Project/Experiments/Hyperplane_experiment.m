...
df_path = 'C:\Users\yotam\Desktop\yotam\python\Phenomics_PreProcessing_Scripts\Relevent_for_yotam\Concept_drift\CB_Project\Data\Hyperplane';
save_path = 'C:\Users\yotam\Desktop\yotam\python\Phenomics_PreProcessing_Scripts\Relevent_for_yotam\Concept_drift\CB_Project\Results\Hyperplane';
...
for p=1:n_permutations
    ...
    df = readtable([df_path '\\' 'Hyperplane_data' num2str(p) '_disc.csv']);
    df = table2array(df);
    ...
    if cddrl
        ...
        bnet.names = {'var_1', 'var_2', 'var_3', 'var_4', 'var_5', 'var_6', 'var_7', 'var_8', 'var_9', 'var_10', 'class'};
...
if cddrl
    ...
    if cb
        writetable(All_Results,[save_path '\Hyperplane_CDDRL_CB_Results.csv']);
    else
        writetable(All_Results,[save_path '\Hyperplane_CDDRL_S&S_Results.csv']);
    end
    ...
    writetable(All_Results,[save_path '\Hyperplane_Rest_Results.csv']);
    writetable(All_RunTimes,[save_path '\Hyperplane_Rest_RunTimes.csv'], 'WriteRowNames', 1);
end
end